...
*** TODO checkboxes
#+begin_src emacs-lisp
   ;(set-face-attribute 'org-checkbox (selected-frame) :foreground "#000000", :background "#93a1a1" :box (:line-width -3 :color "#93a1a1" :style "released-button")))
#+end_src
*** bullets
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
    ...
    ;; C-c o
#+end_src
** TODO which-key for interactive help/mind jogger
#+begin_src emacs-lisp
