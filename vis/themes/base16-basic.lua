-- based on default https://github.com/martanne/vis/blob/master/lua/themes/dark-16.lua
-- edited by sherlach https://github.com/sherlach
-- feel free to use however you wish, credit not required since it's basically just the default
