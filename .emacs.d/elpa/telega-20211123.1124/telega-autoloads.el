...
If called interactively, toggle `Telega-Mode-Line mode'.  If the
...
If called interactively, toggle `Telega-Appindicator mode'.  If
...
If called interactively, toggle `Telega-Autoplay mode'.  If the
prefix argument is positive, enable the mode, and if it is zero
or negative, disable the mode.
...
If called interactively, toggle `Telega-Squash-Message mode'.  If
the prefix argument is positive, enable the mode, and if it is
zero or negative, disable the mode.
...
If called interactively, toggle `Global Telega-Squash-Message
...
If called interactively, toggle `Telega-Edit-File mode'.  If the
prefix argument is positive, enable the mode, and if it is zero
or negative, disable the mode.
...
If called interactively, toggle `Telega-Notifications mode'.  If
the prefix argument is positive, enable the mode, and if it is
zero or negative, disable the mode.
